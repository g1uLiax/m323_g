...
describe('URL Parser', () => {
    ...
    test('resolveAndNormalizeUrl should resolve relative paths against base URL', () => {
        ...
        assert.strictEqual(resolveAndNormalizeUrl('page2.html', base), 'https://example.com/docs/page2.html');
        assert.strictEqual(resolveAndNormalizeUrl('/global.css', base), 'https://example.com/global.css');
        assert.strictEqual(resolveAndNormalizeUrl('../images/logo.png', base), 'https://example.com/images/logo.png');
    });
    ...
    test('resolveAndNormalizeUrl should strip URL fragments', () => {
        const base = 'https://example.com';
        assert.strictEqual(resolveAndNormalizeUrl('http://example.org/home#section-header', base), 'http://example.org/home');
        assert.strictEqual(resolveAndNormalizeUrl('/about#team', base), 'https://example.com/about');
    });
