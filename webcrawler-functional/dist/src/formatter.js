 ...
 */
function formatTreeRepresentation(node, indent = '') {
 ...
 */
function collectVisitedPages(node) {
 ...
 */
function formatDetailsRepresentation(nodes) {
    if (nodes.length === 0) {
 ...
 */
export function formatCrawlResult(root, seedUrl, maxDepth, maxPages) {
